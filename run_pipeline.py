...
def fetch_all_news(api, tickers):
    ...
    for ticker in tickers:
        ...
        except Exception as e: print(f"An error occurred fetching news for {ticker}: {e}")
...
def setup_database_table(conn):
    ...
    # ... (rest of function is unchanged)
    create_table_query = "CREATE TABLE stock_data (Date DATE NOT NULL, Ticker VARCHAR(10) NOT NULL, Close NUMERIC(15, 4) NOT NULL, High NUMERIC(15, 4) NOT NULL, Low NUMERIC(15, 4) NOT NULL, Open NUMERIC(15, 4) NOT NULL, Volume BIGINT NOT NULL, vader_avg_score FLOAT, finbert_avg_score FLOAT, article_count INTEGER, PRIMARY KEY (Date, Ticker));"
...
def get_pipeline_args():
    ...
    parser = argparse.ArgumentParser(description="Run or schedule the data pipeline.")
